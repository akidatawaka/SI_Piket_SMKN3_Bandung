 ...
 * @author tawakida
 */
public class frm_tampil_guru extends javax.swing.JFrame {
    //deklarasi variabel
    koneksi dbsetting;
    ...
    /**
     * Creates new form frm_tampil_guru
     */
    public frm_tampil_guru() {
        initComponents();
    ...
    private void settableload()
    {
        ...
        try
        {
           ...
           String SQL = "select nip,nama,mata_pelajaran from guru";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tampil Data Guru");

        tbl_guru.setAutoCreateRowSorter(true);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(5, 5, 5)
                .addComponent(btn_kembali, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txt_pencarianKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_pencarianKeyReleased
        ...
        try
        {
            ...
            Statement stt = kon.createStatement();
            String SQL = "select nip,nama,mata_pelajaran from guru where nip like '%"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_tampil_guru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_tampil_guru().setVisible(true);
            }
        });
    }
