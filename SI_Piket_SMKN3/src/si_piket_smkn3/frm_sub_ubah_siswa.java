 ...
 * @author tawakida
 */
public class frm_sub_ubah_siswa extends javax.swing.JFrame {
    
    //deklarasi variabel
    String nis, nama, jurusan, kelas;

    /**
     * Creates new form frm_sub_ubah_siswa
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_sub_ubah_siswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_sub_ubah_siswa().setVisible(true);
            }
        });
    }
